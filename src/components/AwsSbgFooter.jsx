...
function InstagramIcon({ size = 18, ...props }) {
  return (
    ...
    >
      <defs>
        <radialGradient id="ig-gradient-footer" r="150%" cx="30%" cy="107%">
      ...
      <rect x="2.5" y="2.5" width="19" height="19" rx="5" ry="5" stroke="url(#ig-gradient-footer)" strokeWidth="2" />
      <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" stroke="url(#ig-gradient-footer)" strokeWidth="2" />
